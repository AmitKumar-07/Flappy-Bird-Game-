...
# initializing Variables as global for the game
FPS = 30
SCREENWIDTH = 288
SCREENHEIGHT = 512
SCREEN = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT)) #screen setting
...
if __name__ == "__main__":
    #  Game will start fro here
    pygame.init() # Initialize all pygame's modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('GamebyAmit')
    ...
    GAME_SPRITES['message'] =pygame.image.load('media/sprites/message.jpeg').convert_alpha()
    ...
    while True:
        allowGame() # Show initial screen to the user until he presses a button for starting game
